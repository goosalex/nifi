...
public class ConsumeKafkaAvro_2_0 extends AbstractProcessor {
    ...
    protected ConsumerPool createConsumerPool(final ProcessContext context, final ComponentLog log) {
        ...
        final String topicListing = context.getProperty(ConsumeKafkaAvro_2_0.TOPICS).evaluateAttributeExpressions().getValue();
        final String topicType = context.getProperty(ConsumeKafkaAvro_2_0.TOPIC_TYPE).evaluateAttributeExpressions().getValue();
